...
#define TSK_STACK_CANARY 1416 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 6704 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 8336 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 8232 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 8312 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 8328 /* offsetof(struct task_struct, thread.mte_ctrl) */
